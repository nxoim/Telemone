...
@Composable
fun LegalItem(
	navController: NavController<AboutDestinations> = getExistingNavController()
) {
	AboutCard(label = "Legal") {
			...
			Modifier
				.clickable {
					navController.navigate(
						AboutDestinations.Dialogs.PrivacyPolicyDialog,
						ContentType.Overlay
					)
				}
				.fillMaxWidth()
		...
		Column(
			Modifier
				.clickable {
					navController.navigate(
						AboutDestinations.Dialogs.TosDialog,
						ContentType.Overlay
					)
				}
				.fillMaxWidth()
