                        ...
                        if (number869Expanded) {
                            ...
                            Row(
                                ...
                                Text(
                                    ...
                                    modifier = Modifier
                                        .clickable(onClick = {
                                            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/$number869Github"))
                            ...
                            Row(
                                ...
                                Text(
                                    ...
                                    modifier = Modifier
                                        .clickable(onClick = {
                                            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://t.me/$number869Telegram"))
                                            context.startActivity(intent)
                                        }),
                                    style = MaterialTheme.typography.bodyMedium
                                )
                        ...
                        if (Lambada10Expanded) {
                            ...
                            Row(
                                ...
                                Text(
                                    ...
                                    modifier = Modifier
                                        .clickable(onClick = {
                                            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/$Lambada10Github"))
                                            context.startActivity(intent)
                                        }),
                                    style = MaterialTheme.typography.bodyMedium
                                )
                            ...
                            Row(
                                ...
                                Text(
                                    ...
                                    modifier = Modifier
                                        .clickable(onClick = {
                                            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://t.me/$Lambada10Telegram"))
                                            context.startActivity(intent)
                                        }),
                                    style = MaterialTheme.typography.bodyMedium
                                )
